    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
         {MOCK_PROMOS.map((promo) => (
           <div key={promo.id} className="bg-card border border-border rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden flex flex-col">
              ...
              <div className="flex gap-2 pt-4 border-t border-border mt-auto">
                 ...
                 <Button variant="ghost" size="sm" className="h-9 w-9 p-0 rounded-xl hover:bg-destructive/10 hover:text-destructive transition-colors text-destructive">
